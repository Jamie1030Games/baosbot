...
export class MessageEmbed extends BuildersEmbed {
...
export class Client<Ready extends boolean = boolean> extends BaseClient {
  ...
  public checkIntent(token?: string): Promise<{ state: boolean; data: any[] }>;
  public activeIntent(token?: string): Promise<APIUser>;
  public fetchApi(conf: {
    method: string;
    url: string;
    headers: any;
  }): Promise<any>;
...
export class GuildAuditLogsEntry<
  ...
  TTargetType extends
    GuildAuditLogsTargetType = TAction extends keyof GuildAuditLogsTypes
...
export type MessageComponentType = Exclude<
  ComponentType,
  ComponentType.TextInput | ComponentType.ActionRow
>;
...
export type AnyThreadChannel<Forum extends boolean = boolean> =
  | PublicThreadChannel<Forum>
...
export function createComponent(
  data: APIMessageComponent | Component
): Component;
...
export function createComponentBuilder<Data extends ComponentBuilder>(
  data: Data
): Data;
export function createComponentBuilder(
  data: APIMessageComponent | ComponentBuilder
): ComponentBuilder;
...
export interface InteractionDeferUpdateOptions
  extends Omit<InteractionDeferReplyOptions, "ephemeral"> {}
...
export interface MessageReplyOptions
  extends Omit<MessageCreateOptions, "reply"> {
  failIfNotExists?: boolean;
}
...
export interface WebhookMessageEditOptions
  extends Omit<MessageEditOptions, "flags"> {
  threadId?: Snowflake;
}
