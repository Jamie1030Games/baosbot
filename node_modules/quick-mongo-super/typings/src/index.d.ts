...
import { IMongoConnectionOptions, IDatabaseObject, IDatabaseEvents, IVersionData, MongoLatency, PropertyValue, DatabaseReturnType } from './interfaces/QuickMongo';
/**
 * QuickMongo class.
 * @extends {Emitter}
 */
declare class Mongo<K = string, V = null, IsUsingDatabaseProperties extends boolean = false> extends Emitter<IDatabaseEvents> {
    ready: boolean;
    ...
    */
     ...
     */
    set<T = V, P = V>(key: K, value: PropertyValue<T, V>): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     ...
     */
    remove<P = V>(key: K): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     * Removes the property from the existing object in database.
     *
     ...
     * @returns {Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>} If cleared: true; else: false.
     */
    delete<P = V>(key: K): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     ...
     */
    add<P = V>(key: K, value: number): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     ...
     * @returns {Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>} If set successfully: true; else: false
     */
    subtract<P = V>(key: K, value: number): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     * Fetches the data from the database.
     *
     ...
     * @returns {Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>} If cleared: true; else: false.
     */
    push<T = V, P = V>(key: K, value: PropertyValue<T, V>): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     ...
     * @returns {Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>} If cleared: true; else: false.
     */
    pop<T = V, P = V>(key: K, index: number): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     * Removes an element from a specified array in the database.
     *
     * [!!!] The target must be an array.
     ...
     * @returns {Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>} If cleared: true; else: false.
     */
    removeElement<P = V>(key: K, index: number): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     ...
     * @returns {Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>} If cleared: true; else: false.
     */
    pull<T = V, P = V>(key: K, index: number, newValue: PropertyValue<T, V>): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     * Changes the specified element's value in a specified array in the database.
     *
     * [!!!] The target must be an array.
     ...
     * @returns {Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>} If cleared: true; else: false.
     */
    changeElement<T = V, P = V>(key: K, index: number, newValue: PropertyValue<T, V>): Promise<DatabaseReturnType<IsUsingDatabaseProperties, V, P>>;
    /**
     ...
     */
    all<P = Record<string, any>, UseDatabaseProperties extends boolean = IsUsingDatabaseProperties>(): Promise<DatabaseReturnType<UseDatabaseProperties, P, P>>;
    /**
